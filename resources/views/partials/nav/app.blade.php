            ...
            <ul class="navbar-nav ml-auto navbar-right-top">
                @can('isAdmin')
                    <li class="nav-item">
                        @if ((\Request::route()->getPrefix()) == '/admin')
                            <a class="nav-link nav-icons" href="{{ route('user.dashboard') }}" aria-haspopup="true" aria-expanded="false">
                                <span class="indicator"></span>
                                Go To User Panel
                            </a>
                        @else
                            <a class="nav-link nav-icons" href="{{ route('admin.dashboard') }}" aria-haspopup="true" aria-expanded="false">
                                <span class="indicator"></span>
                                Go To Admin Panel
                            </a>
                        @endif
                ...
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                        ...
                        <a class="dropdown-item" href="{{ route('user.pin.index') }}"><i class="fas fa-cog mr-2"></i>Pin</a>
